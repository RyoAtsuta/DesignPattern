...
public class DataMartObserver2 implements Observer {
    ...
    private void send(Database database) {
        System.out.println("========= DataMartObserver2 Send Database ========");
        ...
        System.out.println("========= End of DataMartObserver2 Send Database ========");
    }
}